...
export default function LoadingSpinner(props: { className?: string; style?: CSSProperties }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} fill="currentColor" viewBox="0 0 32 32" className={`animate-spin ${props.className}`} style={props.style}>
